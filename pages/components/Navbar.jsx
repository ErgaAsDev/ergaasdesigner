...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex md:gap-7 md:ml-[7vw] items-center justify-between md:justify-start">
      <Image 
      src={cultigoLogo}
      className="ml-5 mt-5 self-center"/>
      <ul className="hidden md:flex md:text-lg md:gap-10 md:pt-3 ml-8">
        <li className="mt-2 ml-5"><a href="" className="hover:text-[#5ED600]">Programs</a></li>
        <li className="mt-2 ml-5"><a href="" className="hover:text-[#5ED600]">Events</a></li>
        <li className="mt-2 ml-5"><a href="" className="hover:text-[#5ED600]">Journal</a></li>
      </ul>
    ...
    { isOpen && <ul className="flex flex-col items-center md:hidden">
        <li className="mt-3 ml-5"><a href="" className="hover:text-[#5ED600]">Programs</a></li>
        <li className="mt-2 ml-5"><a href="" className="hover:text-[#5ED600]">Events</a></li>
        <li className="mt-2 ml-5"><a href="" className="hover:text-[#5ED600]">Journal</a></li>
      </ul>  }
